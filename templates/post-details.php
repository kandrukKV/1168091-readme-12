                ...
                <div class="post-details__main-block post post--details">
                    ...
                    <div class="post__indicators">
                        <div class="post__buttons">
                            <a class="post__indicator post__indicator--likes button"<?= !$post_details['is_like'] ? ' href="/like.php?id=' . $post_details['id'] . '"' : ''  ?> title="Лайк">
                ...
                <div class="post-details__user user">
                    ...
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            <span class="post-details__rating-amount user__rating-amount"><?= $user_num_of_subscribers ?></span>
                            <span class="post-details__rating-text user__rating-text">подписчиков</span>
                        </p>
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            <span class="post-details__rating-amount user__rating-amount"><?= $user_num_of_posts ?></span>
