            ...
            <form class="authorization__form form" action="/index.php" method="post">
                <div class="authorization__input-wrapper form__input-wrapper">
                    ...
                    <?php if(isset($errors['email'])) : ?>
                        <span class="form__error-label" style="position: static; font-size: 12px"><?= $errors['email'] ?></span>
                    <?php endif; ?>
                ...
                <div class="authorization__input-wrapper form__input-wrapper">
                    ...
                    <?php if(isset($errors['password'])) : ?>
                        <span class="form__error-label" style="position: static; font-size: 12px"><?= $errors['password'] ?></span>
                    <?php endif; ?>
