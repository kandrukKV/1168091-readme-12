                ...
                <ul class="popular__filters-list filters__list">
                    ...
                    <?php foreach ($content_types as $content_type):?>
                        <li class="popular__filters-item filters__item">
                            <a class="filters__button filters__button--<?= $content_type['class_name'] ?> button <?=  $content_type_id === $content_type['id'] ? 'filters__button--active' : ''?>" href="index.php?content_type=<?= $content_type['id']?>">
