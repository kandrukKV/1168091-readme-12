                ...
                <?php if ($header_type !== 'registration'): ?>
                    <ul class="header__my-nav">
                        <li class="header__my-page header__my-page--popular">
                            <a class="header__page-link<?= $header_type === 'popular' ? ' header__page-link--active' : '' ?>"
                               href="/popular.php" title="Популярный контент">
                                <span class="visually-hidden">Популярный контент</span>
                            </a>
                        </li>
                        <li class="header__my-page header__my-page--feed">
                            <a class="header__page-link<?= $header_type === 'feed' ? ' header__page-link--active' : '' ?>"
                               href="/feed.php" title="Моя лента">
                                <span class="visually-hidden">Моя лента</span>
                            </a>
                        </li>
                        <li class="header__my-page header__my-page--messages">
                            <a class="header__page-link<?= $header_type === 'messages' ? ' header__page-link--active' : '' ?>"
                            ...
                            <a class="header__profile-link" href="/profile.php">
                                <div class="header__avatar-wrapper">
                                    <img class="header__profile-avatar"
                                         src="/uploads/<?= $_SESSION['avatar'] ?? 'unnamed.png' ?>"
                                         alt="Аватар профиля">
                                </div>
                    ...
                    <?php else : ?>
                        <li class="header__authorization">
                            <a class="header__user-button header__authorization-button button"
                               href="<?= $header_type === 'registration' ? '/index.php' : '/login.html' ?>">Вход</a>
                        </li>
                        <li>
